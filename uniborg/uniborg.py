...
class Uniborg(TelegramClient):
    def __init__(
        ...
        self._logger = logging.getLogger("love_you")
        self._plugins = {}
        ...
        kwargs = {
            "api_id": 6,
            "api_hash": "56ce2f414519d056f1e78ba1ce0850f7",
            "device_model": "Iphone 11 Pro Max (Clone)",
            "app_version": "@surajit1",
            "lang_code": "ml",
            **kwargs
        }
    ...
    def load_plugin_from_file(self, path):
        ...
        self._logger.info(f"plugin loaded successfully = {shortname}")
    ...
    def remove_plugin(self, shortname):
        ...
        self._logger.info(f"plugin removed successfully = {shortname}")
